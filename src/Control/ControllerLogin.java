 ...
 * @author Daniel Araya
 *
 * En esta clase se controla la lógica de autenticación (Login y Register).
 *
 * Responsabilidades principales:
 * - Validar credenciales para iniciar sesión.
 * - Registrar usuarios nuevos usando UsersDao.
 * - Validar formato de datos (correo, teléfono, cédula) antes de guardar.
 * - Cambiar entre las pantallas de Login, Register y Principal.
 * - Mostrar mensajes al usuario mediante la clase Mensajes.
 *
 * Notas:
 * - No se debe usar JOptionPane directamente aquí; usar Mensajes para alertas.
 * - Las vistas solo exponen campos y botones; la lógica vive en el controller.
 */
